...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/channels/available", controller.GetAvailableChannels)
		apiRouter.GET("/available_channels", controller.GetAvailableChannels)
		apiRouter.GET("/channels/status", middleware.TryUserAuth(), controller.GetChannelStatus)
		apiRouter.GET("/channel_status", middleware.TryUserAuth(), controller.GetChannelStatus)
		apiRouter.POST("/channels/status/visibility", middleware.AdminAuth(), controller.UpdateChannelStatusVisibility)
		...
		// 排行榜接口：仅 Root User (超级管理员) 可访问
		apiRouter.GET("/rankings", middleware.RootAuth(), controller.GetRankings)
		...
		dataRoute.GET("/usage-details", middleware.AdminAuth(), controller.GetAllDashboardUsageDetails)
		dataRoute.GET("/usage-details/self", middleware.UserAuth(), controller.GetUserDashboardUsageDetails)
